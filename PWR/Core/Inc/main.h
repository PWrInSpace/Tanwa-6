...
#define BatteryVoltage_Pin GPIO_PIN_2
...
#define Ser2PWM_Pin GPIO_PIN_6
#define Ser2PWM_GPIO_Port GPIOB
#define Ser2Dir_Pin GPIO_PIN_7
#define Ser2Dir_GPIO_Port GPIOB
#define Ser1PWM_Pin GPIO_PIN_8
#define Ser1PWM_GPIO_Port GPIOB
#define Ser1Dir_Pin GPIO_PIN_9
#define Ser1Dir_GPIO_Port GPIOB
